...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  cicdAddProvider:   (providerId) => ipcRenderer.invoke('python:cicd-add-provider', providerId),
  llmOpsStatus:      ()           => ipcRenderer.invoke('python:llm-ops-status'),
  llmOpsReadPromptAsset: (payload) => ipcRenderer.invoke('python:llm-ops-read-prompt-asset', payload),
  llmOpsCreatePromptsDir: () => ipcRenderer.invoke('python:llm-ops-create-prompts-dir'),
  llmOpsReadEvalAsset: (payload) => ipcRenderer.invoke('python:llm-ops-read-eval-asset', payload),
  llmOpsTestConnection: (payload) => ipcRenderer.invoke('python:llm-ops-test-connection', payload),
  llmOpsRunPromptTest: (payload) => ipcRenderer.invoke('python:llm-ops-run-prompt-test', payload),
